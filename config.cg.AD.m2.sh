...
IN="/panfs/cguccion/23_11_07_HostDepletionBenchmarkOverflow/AD/raw"
current_fn="AD_m2"
OUT="/panfs/cguccion/23_11_07_HostDepletionBenchmarkOverflow/AD/host_depleted/${current_fn}"
