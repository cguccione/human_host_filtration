...
fastp -l 45 -i $R1_name -I $R2_name -w 16 --stdout | minimap2 -ax sr -t 16 human-GRC-db.mmi - -a | samtools fastq -@ 16 -f 12 -F 256 | minimap2 -ax sr -t 16 human-GCA-phix-db.mmi - -a | samtools fastq -@ 16 -f 12 -F 256 -1 $final_output/$R1.v0.gz -2 $final_output/$R2.v0.gz
