...
IN="/panfs/cguccion/23_11_07_HostDepletionBenchmarkOverflow/exome/raw"
current_fn="exome_1M_m2"
OUT="/panfs/cguccion/23_11_07_HostDepletionBenchmarkOverflow/exome/host_depleted/${current_fn}"
