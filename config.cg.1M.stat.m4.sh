...
IN="/panfs/cguccion/23_11_07_HostDepletionBenchmarkOverflow/mixed_simulation_tmp/final_combo/LITTLE_50.00p-HUMAN_50.00p-MICROBE/raw/fastq_paired/h1000000-m1000000/time_test"
current_fn="1M_stat_m4"
...
MODE="PE+SE" # "SE" (single-end) or "PE" (paired-end)
